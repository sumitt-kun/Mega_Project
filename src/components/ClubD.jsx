...
export default function Sample() {
  ...
  console.log(na);
  return (
    <div className="flex h-full p-7 flex-col bg-[url('/static/images/dashbg.jpg')] text-white bg-no-repeat bg-center bg-cover bg-fixed items-center justify-evenly px-[10%] text-center">
      <ClubData />
    </div>
  );
}
